...
from src.app.schemas.question import  QuestionCreateInternal, QuestionResponse, QuestionUpdate
...
question_crud = FastRDB[Question , QuestionCreateInternal , QuestionUpdate , QuestionResponse](
    Question,
    QuestionResponse,
    pattern="todo" , 
